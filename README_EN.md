...
2.  Open a terminal and run:
    ...
    ```
    *The server will start at `http://localhost:8080`. It will automatically create the database and tables on the first run.*
...
3.  Start the development server:
    ...
    npm run dev
    ```
    *Access `http://localhost:8020` in your browser.*
...
### How can you help?
*   ✨ **Suggest Features:** Have an idea for a new mechanic or visual effect? Open an *Issue*!
...
*   **Developed by:** Antigravity & Grimoire Community.
